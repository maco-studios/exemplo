...
public class DataLoader {
    ...
    public CommandLineRunner loadData(
        ...
        return args -> {
            ...
            Usuario usuario1 = new Usuario("João", "Silva", "joao.silva@example.com", passwordEncoder.encode("senha123"));
            Usuario usuario2 = new Usuario("Maria", "Santos", "maria.santos@example.com", passwordEncoder.encode("senha456"));
            Usuario usuario3 = new Usuario("Pedro", "Oliveira", "pedro.oliveira@example.com", passwordEncoder.encode("senha789"));
